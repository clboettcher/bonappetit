...
public class ValueOptionBuilder {
    ...
    public ValueOptionBuilder but() {
        return aValueOption().withPriceDiff(priceDiff).withDefaultChecked(defaultChecked).withDefaultValue(defaultValue).withId(id).withTitle(title).withIndex(index);
    }
    ...
    public ValueOption build() {
        ...
        valueOption.setDefaultValue(defaultValue);
