...
public class OrderDaoImpl implements OrderDao {
    ...
    @Override
    public Iterable<ItemOrderEntity> save(Collection<ItemOrderEntity> orders) {
        LOGGER.info(String.format("Saving %d order(s): %s", orders.size(), orders));
        return repository.save(orders);
    }

    @Override
    public Iterable<ItemOrderEntity> update(Iterable<ItemOrderEntity> itemOrderEntities) {
        return repository.save(itemOrderEntities);
    }
}
